 ...
 */
final class Version20240308104507 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE faq (id INT AUTO_INCREMENT NOT NULL, page_tab_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, time_create DATETIME NOT NULL, time_update DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_E8FF75CCE2DA653D (page_tab_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE faq ADD CONSTRAINT FK_E8FF75CCE2DA653D FOREIGN KEY (page_tab_id) REFERENCES page_tab (id) ON DELETE SET NULL');
        ...
        $this->addSql('ALTER TABLE page_tab ADD faq_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE page_tab ADD CONSTRAINT FK_BF5C4B9D81BEC8C2 FOREIGN KEY (faq_id) REFERENCES faq (id) ON DELETE SET NULL');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_BF5C4B9D81BEC8C2 ON page_tab (faq_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE page_tab DROP FOREIGN KEY FK_BF5C4B9D81BEC8C2');
        ...
        $this->addSql('DROP INDEX UNIQ_BF5C4B9D81BEC8C2 ON page_tab');
        $this->addSql('ALTER TABLE page_tab DROP faq_id');
