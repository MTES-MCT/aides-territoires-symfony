 ...
 */
final class Version20250214091930 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ab_test_user (id INT AUTO_INCREMENT NOT NULL, ab_test_id INT NOT NULL, user_id INT DEFAULT NULL, variation VARCHAR(50) NOT NULL, date_create DATE NOT NULL, cookie_id VARCHAR(255) NOT NULL, INDEX IDX_E666FC1CA00D9457 (ab_test_id), INDEX IDX_E666FC1CA76ED395 (user_id), INDEX variation_ab_test_user (variation), INDEX date_create_ab_test_user (date_create), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ab_test_vote (id INT AUTO_INCREMENT NOT NULL, ab_test_id INT NOT NULL, aid_id INT DEFAULT NULL, ab_test_user_id INT NOT NULL, vote INT NOT NULL, php_session_id VARCHAR(255) NOT NULL, variation VARCHAR(255) NOT NULL, data VARCHAR(255) DEFAULT NULL, date_create DATE NOT NULL, INDEX IDX_31E5AF31A00D9457 (ab_test_id), INDEX IDX_31E5AF31CB0C1416 (aid_id), INDEX IDX_31E5AF316FA5F51E (ab_test_user_id), INDEX variation_ab_test_vote (variation), INDEX date_create_ab_test_vote (date_create), INDEX php_session_id_ab_test_vote (php_session_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE ab_test_vote ADD CONSTRAINT FK_31E5AF316FA5F51E FOREIGN KEY (ab_test_user_id) REFERENCES ab_test_user (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ab_test_vote DROP FOREIGN KEY FK_31E5AF316FA5F51E');
