...
#[AsCommand(name: 'at:import:log_aid_application_url_click', description: 'Import log aid application url click')]
class LogAidApplicationUrlClickImportCommand extends ImportCommand
{
    protected string $commandTextStart = '>Import log aid application url click';
    protected string $commandTextEnd = '<Import log aid application url click';

    protected function import($input, $output)
    {
        // ==================================================================
        // LOG AID APPLICATION URL CLICK
        // ==================================================================

        $io = new SymfonyStyle($input, $output);
        $io->info('LOG AID APPLICATION URL CLICK');

        // fichier
        $filePath = $this->findCsvFile('stats_aidapplicationurlclickevent_');
        if (!$filePath) {
