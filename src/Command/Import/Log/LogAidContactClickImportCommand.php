...
#[AsCommand(name: 'at:import:log_aid_contact_click', description: 'Import log aid contact click')]
class LogAidContactClickImportCommand extends ImportCommand
{
    protected string $commandTextStart = '>Import log aid contact click';
    protected string $commandTextEnd = '<Import log aid contact click';

    protected function import($input, $output)
    {
        // ==================================================================
        // LOG AID CONTACT CLICK
        // ==================================================================

        $io = new SymfonyStyle($input, $output);
        $io->info('LOG AID CONTACT CLICK');

        // fichier
        $filePath = $this->findCsvFile('stats_aidcontactclickevent_');
        if (!$filePath) {
