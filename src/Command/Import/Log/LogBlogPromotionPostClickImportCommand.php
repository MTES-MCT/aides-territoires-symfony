...
#[AsCommand(name: 'at:import:log_blog_promotion_post_click', description: 'Import log blog promotion post click')]
class LogBlogPromotionPostClickImportCommand extends ImportCommand
{
    protected string $commandTextStart = '>Import log blog promotion post click';
    protected string $commandTextEnd = '<Import log blog promotion post click';

    protected function import($input, $output)
    {
        // ==================================================================
        // LOG BLOG BLOG PROMOTION POST CLICK
        // ==================================================================

        $io = new SymfonyStyle($input, $output);
        $io->info('LOG BLOG BLOG PROMOTION POST CLICK');

        // fichier
        $filePath = $this->findCsvFile('stats_promotionclickevent_');
        if (!$filePath) {
        ...
        $sqlBase = "INSERT INTO `log_blog_promotion_post_click`
        (
