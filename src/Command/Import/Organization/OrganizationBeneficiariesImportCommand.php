...
#[AsCommand(name: 'at:import:organization_beneficiairies', description: 'Import organization beneficiairies')]
class OrganizationBeneficiariesImportCommand extends ImportCommand
{
    protected string $commandTextStart = '>Import organization beneficiairies';
    protected string $commandTextEnd = '<Import organization beneficiairies';

    protected function import($input, $output)
    {
        // ==================================================================
        // organization beneficiairies
        // ==================================================================

        $io = new SymfonyStyle($input, $output);
        $io->info('organization beneficiairies');

        // fichier
        $filePath = $this->findCsvFile('organizations_organization_beneficiaries_');
        if (!$filePath) {
        ...
        $sqlBase = "INSERT INTO `organization_user`
                    (
                    organization_id,
                    user_id
                    )
