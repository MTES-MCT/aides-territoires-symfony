...
class ImportKeywordReferenceCommand extends Command
{
    ...
    protected function importKeyword($input, $output): void
    {
        $object_projects = array(
            ...
            "chapelle" => array("lieux de culte","chapelles","cimetière","cimetières","columbarium","columbariums","église","églises","enterrement","enterrements","funéraille","funérailles","funéraire","funéraires","funérarium","funérariums","monument morts","obsèque","obsèques","pierre tombale","presbytère","presbytères","sépulture","sépultures","tombe","tombes"),
            ...
            "arrangement" => array("arrangements","arranger","concéder","concession","concessions","établir","ordonner","ordre","ordres","organisation","organisations","organiser","planification","planifications","planifier","préparation","préparations","préparer","programmation","programmations","programmer"),
            ...
            "commencement" => array("commencements","commencer","début","débuter","débuts","établir","initiation","initiations","initier","instauration","instaurations","instaurer","introduction","introductions","introduire","lancement","lancements","lancer"),
            "commencement" => array("commencements","commencer","démarrer","établir","inaugurer","initiation","initiations","initier","instauration","instaurations","instaurer","lancement","lancements","lancer","ouverture","ouvertures","ouvrir"),
            "commencement" => array("commencements","commencer","début","débuter","débuts","démarrer","entreprendre","établir","inaugurer","initiation","initiations","initier","lancement","lancements","lancer"),
            ...
            "composer" => array("constituer","construction","constructions","construire","création","créations","créer","établir","former","installation","installations","installer","instituer","institution","institutions","poser","pose"),
            ...
            "définir" => array("définition","définitions","érection","érections","ériger","établir","implantation","implantations","implanter","installation","installations","installer","mettre","mise","mise en place","mises","placement","placements","placer","poser"),
