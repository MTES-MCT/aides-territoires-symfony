...
class BlogPostCategory
{
    ...
    private ?\DateTimeInterface $timeUpdated = null;
    ...
    public function setTimeUpdated(?\DateTimeInterface $timeUpdated): static
    {
    ...
    /**
     * Pour avoir le nom dans le associationField
     *
     * @return string
     */
