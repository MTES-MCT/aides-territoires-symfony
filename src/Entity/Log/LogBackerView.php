...
use App\Repository\Log\LogBackerViewRepository;
...
#[ORM\Entity(repositoryClass: LogBackerViewRepository::class)]
#[ORM\Index(columns: ['date_create'], name: 'date_create_lbv')]
#[ORM\Index(columns: ['source'], name: 'source_lbv')]
class LogBackerView
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
