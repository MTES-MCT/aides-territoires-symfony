...
use App\Repository\Log\LogBlogPromotionPostDisplayRepository;
...
#[ORM\Entity(repositoryClass: LogBlogPromotionPostDisplayRepository::class)]
#[ORM\Index(columns: ['date_create'], name: 'date_create_lbppd')]
#[ORM\Index(columns: ['source'], name: 'date_create_lbppd')]
class LogBlogPromotionPostDisplay
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
