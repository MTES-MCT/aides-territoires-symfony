...
use App\Repository\Log\LogUserActionRepository;
...
#[ORM\Index(columns: ['type'], name: 'type_lua')]
#[ORM\Index(columns: ['data1'], name: 'data1_lua')]
#[ORM\Index(columns: ['data2'], name: 'data2_lua')]
#[ORM\Index(columns: ['date_create'], name: 'date_create_lua')]
...
class LogUserAction
{
    ...
    #[ORM\ManyToOne(inversedBy: 'logUserActions')]
